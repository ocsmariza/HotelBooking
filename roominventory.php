  ...
  <table cellpadding="10" cellspacing="2" id="resultTable">
         ...
         <?php
			   $con = mysql_connect("localhost","root","");
								...
								$result3 = mysql_query("SELECT * FROM roominventory");
...
$result5 = mysql_query("SELECT sum(qty_reserve) FROM roominventory where room_id='13' or room_id='14' or room_id='15' or room_id='15' or room_id='17'");
...
$result6 = mysql_query("SELECT sum(qty_reserve) FROM roominventory where room_id='18' or room_id='19' or room_id='20' or room_id='21' or room_id='22'");
...
$result7 = mysql_query("SELECT sum(qty_reserve) FROM roominventory where room_id='23' or room_id='23' or room_id='25' or room_id='26' or room_id='27'");
