...
<div style="width:auto; margin:10%; position:relative; border:3px solid rgba(0,0,0,0); -webkit-border-radius:5px; -moz-border-radius:5px; border-radius:5px; -webkit-box-shadow:0 0 18px rgba(0,0,0,0.4); -moz-box-shadow:0 0 18px rgba(0,0,0,0.4); box-shadow:0 0 18px rgba(0,0,0,0.4); margin-top:10%;"align="center">
  ...
  <table cellpadding="10" cellspacing="2" id="resultTable">
         ...
         <?php
				...
				while($rows = $result->fetch_assoc()) {
									...
									echo '<td class="contacts">'.'<a rel="facebox" href=deletemonitor.php?id=' . $rows["confirmation"] . '>' . 'Delete' . '</a>'.'</td>';
									echo '</tr>';
				}
